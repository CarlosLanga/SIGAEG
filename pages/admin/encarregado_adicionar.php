...
<div class="main-wrapper">
    ...
    <main class="content-body">
        ...
        <section class="card form-card">
            <h2 class="section-title">Preencher dados do encarregado</h2>
            <div id="form-message" class="form-message" style="display: none;"></div>

            <form action="<?= BASE_URL ?>api/encarregado_add.php" method="POST" data-ajax="true" data-validate="true" data-entity="encarregado" data-entity-title="Encarregado" data-entity-label="encarregado" data-codegen-url="<?= BASE_URL ?>api/gerar_codigo.php" data-success-msg="Encarregado adicionado com sucesso!" data-error-msg="Erro ao adicionar encarregado." data-existing-msg="Encarregado ja existente!">
                <div class="form-grid">
                    ...
                    <label class="form-field">
                        <span>Contacto</span>
                        <input type="text" name="contacto" data-input-mask="mz-contact" inputmode="numeric" maxlength="16" placeholder="+258(XX)XXX-XXXX" autocomplete="off" required>
                    </label>
                    ...
                    <input type="hidden" name="nivel_destinado" value="4">
